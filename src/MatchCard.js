                        ...
                        <div className="match-details">
                            ...
                            <div>
                                <div className="inline-country-details">
                                    <img src="https://image.flaticon.com/icons/svg/206/206626.svg" className="br2 h3 w3 dib image-size" alt="Pic not found"></img>
                                    <span className="f7 lh-copy measure">{row.homeTeamName}</span>
                                </div>
                            </div>
                            <div>
                                <div>
                                    <img src="https://image.flaticon.com/icons/svg/206/206758.svg" className="br2 h3 w3 dib image-size" alt="Pic not found"></img>
